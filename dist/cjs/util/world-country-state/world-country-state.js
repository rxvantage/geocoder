...
exports.WorldCountryState = void 0;
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_transformer_1.Transform)(({ value }) => value === null || value === void 0 ? void 0 : value.toString().trim()),
    (0, class_transformer_1.Expose)(),
    __metadata("design:type", String)
...
exports.WorldCountryState = WorldCountryState;
